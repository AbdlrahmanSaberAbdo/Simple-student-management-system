...
namespace Core\Learning\Tests\Feature;

use Core\Base\Tests\TestCase;
use Core\Learning\Models\Cousrse as Model;

class CousrseTest extends TestCase
{
    /**
     * the base url
     *
    ...
    public function setUp(): void
    {
        ...
        $this->base_url     = $this->getApiBaseUrl() . 'cousrses/';
